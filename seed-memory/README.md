...
- [family] **family** — true for any repo in this archetype (the stack inherently works this way)
- [verify] **verify** — likely true here, confirm against code (versions, class names)
- [fill] **repo-specific** — fill from *your* code

Rule: a [verify]/[fill] line is a **hypothesis** until it cites a real `file:line`. The seed predicts; your code proves.
